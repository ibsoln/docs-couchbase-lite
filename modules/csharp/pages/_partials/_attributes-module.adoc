// BEGIN -- attributes inclusion -- _attributes_module
// Objective -- module specific attributes
// Used-by -- {ROOT}_std-hdr-cbl.adoc
...
:url-api-references-query: {url-api-references2}Query
:url-api-classes-query-pfx: {url-api-references-query}.IQuery.html
