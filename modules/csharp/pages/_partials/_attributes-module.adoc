...
:url-api-method-tls-identity-delete: {url-api-references-tlsidentity-method}DeleteIdentity_System_Security_Cryptography_X509Certificates_X509Store_System_String_System_String_
...
:url-api-method-tls-identity-import: {url-api-references-tlsidentity-method}ImportIdentity_System_Security_Cryptography_X509Certificates_X509Store_System_Byte___System_String_System_String_System_String_
...
:url-api-references-replicator-status: {url-api-references-classes-sync}{api-pfx}Replicator.Status.html
...
:url-api-references-replicator-config-prop: {url-api-references-replicator-config}{sep}{api-pfx}Couchbase_Lite_Sync_ReplicatorConfiguration_
