...
[source]
----
include::{this-snippet}[tag=query-select-meta,indent=0]
----
...
[source]
----
include::{this-snippet}[tag=query-select-all,indent=0]
----
...
[source]
----
include::{this-snippet}[tag=query-where,indent=0]
----
...
[source]
----
include::{this-snippet}[tag=query-collection-operator-contains,indent=0]
----
...
[source]
----
include::{this-snippet}[tag=query-collection-operator-in,indent=0]
----
...
[source]
----
include::{this-snippet}[tag=query-like-operator,indent=0]
----
...
[source]
----
include::{this-snippet}[tag=query-like-operator-wildcard-match,indent=0]
----
...
[source]
----
include::{this-snippet}[tag=query-like-operator-wildcard-character-match,indent=0]
----
...
[source]
----
include::{this-snippet}[tag=query-regex-operator,indent=0]
----
...
[source]
----
include::{this-snippet}[tag=query-deleted-documents,indent=0]
----
...
[source]
----
include::{this-snippet}[tag=query-join,indent=0]
----
...
[source]
----
include::{this-snippet}[tag=query-groupby,indent=0]
----
...
[source]
----
include::{this-snippet}[tag=query-orderby,indent=0]
----
