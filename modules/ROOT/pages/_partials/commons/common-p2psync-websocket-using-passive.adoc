...
+
--
The database name is set using the {url-api-reference-urlendpointconfiguration-database} property.
...
Use the {url-api-reference-urlendpointconfiguration-port} property to configure use of a specific port.
...
Use the
{url-api-reference-urlendpointconfiguration-netwk-iface} property
...
Use the `{url-api-reference-urlendpointconfiguration-delta-sync}
` property of `{url-api-class-urlendpointconfiguration}` to activate or deactivate delta sync mode when replicating.
