...
:cbl-pg-query: learn/query/{param-name}-query.adoc
:cbl-pg-query-using: learn/query/{param-name}-query-using.adoc
:cbl-pg-query-live: learn/query/{param-name}-query-live.adoc
:cbl-pg-query-predictive: learn/query/{param-name}-query-predictive.adoc
:cbl-pg-date-time: learn/query/{param-name}-date-time.adoc
...
:xref-cbl-pg-date-time: {xref-pfx-cbl}{cbl-pg-date-time}[Date Time Functions]
...
:xref-cbl-pg-dbo-p2psync-websocket-using-passive: {xref-pfx-cbl}{cbl-pg-dbo-p2psync-websocket-using-passive}[Deploy Passive Peer]
:xref-cbl-pg-dbo-p2psync-websocket-using-passive--delta-sync: {xref-pfx-cbl}{cbl-pg-dbo-p2psync-websocket-using-passive--delta-sync}[Configure Delta Sync]
:xref-cbl-pg-dbo-p2psync-websocket-using-active: {xref-pfx-cbl}{cbl-pg-dbo-p2psync-websocket-using-active}[Deploy Active Peer]
...
:xref-cbl-pg-dbreplica: {xref-pfx-cbl}{cbl-pg-dbreplica}[Local Replicaton]
...
:xref-cbl-pg-p2psync: {xref-pfx-cbl}{cbl-pg-p2psync}[Peer-to_peer Synchronization]
:xref-cbl-pg-p2psync-http: {xref-pfx-cbl}{cbl-pg-p2psync-http}[P2P - http]
:xref-cbl-pg-p2psync-custom: {xref-pfx-cbl}{cbl-pg-p2psync-custom}[P2P - Custom]
:xref-cbl-pg-p2psync-websocket: {xref-pfx-cbl}{cbl-pg-p2psync-websocket}[P2P - Websocket]
...
:xref-cbl-pg-releasenotes: {xref-pfx-cbl}{cbl-pg-releasenotes}[Release Notes]
:xref-cbl-pg-replication: {xref-pfx-cbl}{cbl-pg-replication}[Working with Replications]
