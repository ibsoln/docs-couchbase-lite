...
:xref-cbl-pg-release-notes-all: {xref-pfx-root}{cbl-pg-release-notes-all}[Release Notes]
:xref-cbl-pg-release-notes: {cbl--pfx}{cbl-pg-release-notes}[Release Notes]
:xref-cbl-pg-release-notes: {cbl--pfx}{cbl-pg-release-notes}[Release Notes]
