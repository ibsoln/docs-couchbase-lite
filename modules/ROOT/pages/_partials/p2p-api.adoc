...
Use the `{url-api-references-urlendpointconfiguration-disable-tls}`  property of `{url-api-class-urlendpointconfiguration}` to disable TLS communication if necessary
...
* If `disableTLS` is true -- TLS communication is disabled and the `{url-api-references-urlendpointconfiguration-tls-id}` property is ignored.
* If `disableTLS` is false or not specified -- TLS communication is enabled.
Set the required `{url-api-references-urlendpointconfiguration-tls-id}` property.
...
Use the
{url-api-references-urlendpointconfiguration-tls-id} property of
