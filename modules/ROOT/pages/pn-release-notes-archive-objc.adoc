= Release Notes Archive (Objective-C)
include::partial$_attributes-local.adoc[]
:this-version: {version}
:xref-pfx: {xref-pfx-cbl}:
:pg-objc: objc.adoc
:xref-pg-objc: {pg-objc}
:xref-pg-objc--release-notes: {xref-pfx}{pg-objc}#release-notes[Release Notes for {this-version}]

For current release notes see: {xref-pg-objc--release-notes}
