...
image::ROOT::attach_replicated.png[]
...
Logging messages Couchbase Lite code are not shown up in console
...
* {url-issues-java}/1665[*#1665*] Exception thrown openDatabase (Proguard strips methods that Couchbase Lite uses)
...
* {url-issues-java}/1702[*#1702*] ValueIndexItem.expression(Expression) is implemented with Couchbase Lite Android 2.0.0 release.
