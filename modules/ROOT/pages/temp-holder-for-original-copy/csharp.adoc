...
image::ROOT::ROOT::attach_replicated.png[]
...
include::partial$::{root-commons}certificate-pinning.adoc
...
// - https://issues.couchbase.com/browse/CBL-489[*CBL-489*] xamarin-iOS : Not connecting back to SGW with ssl when SGW restarts
...
// - https://issues.couchbase.com/browse/CBL-395[*CBL-395*] Platform WebSocket code should manage HTTP cookies - Android - .NET
// - https://issues.couchbase.com/browse/CBL-355[*CBL-355*] Queries silently ignore Collation Locale
// - https://issues.couchbase.com/browse/CBL-349[*CBL-349*] TestNonBlockingDatabaseOperationConflictResolver can silently fail
...
* https://issues.couchbase.com/browse/CBL-2[*CBL-2*] [sg-ssl enabled] Couchbase Lite replicator does not resume after SG restart
...
[xamarin-ios][sg-ssl enabled] Couchbase Lite replicator does not resume after SG
restart
