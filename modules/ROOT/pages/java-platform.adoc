...
:pg-relnote-archive: pn-release-notes-archive-java-platform.adoc
:xref-pg-relnote-archive: {xref-pfx}{pg-relnote-archive}[Release Notes Archive]
...
These release notes cover _Release {this-version}_ and any subsequent _{this-version}.x_ maintenance releases.

<<2-7, Release Notes for Release {this-version}>> | <<support-notices, Current Support Notices>> | {xref-pg-relnote-archive}
...
==== {nftr} at {this-version}

New at release {this-version} is the Java Platform, which enables development of Java apps on any platform that supports the JVM model
