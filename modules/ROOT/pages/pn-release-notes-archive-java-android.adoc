...
:pg-android: java-android.adoc
:xref-pg-android--release-notes: {xref-pfx}{pg-android}#release-notes[Release Notes for {this-version}]

For current release notes see: {xref-pg-android--release-notes}
