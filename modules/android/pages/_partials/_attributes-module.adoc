...
:url-api-method-tls-identity-import: {url-api-references-tlsidentity}{sep}c:android(cs){api-pfx}TLSIdentity(cm)importIdentityWithData:password:label:error:[importIdentity(withData:password:label:error:)]

:url-api-class-urlendpointconfiguration: {url-api-references-urlendpointconfiguration}[URLEndpointListenerConfiguration]

:url-api-references-urlendpointconfiguration-property: {url-api-references-urlendpointconfiguration}{sep}c:android(cs){api-pfx}URLEndpointListenerConfiguration
...
:url-api-properties-replicator: {url-api-references-replicator}{sep}c:android(cs){api-pfx}Replicator
...
:url-api-property-replicator-status: {url-api-properties-replicator}(py)status[replicator.getStatus]
...
:url-api-properties-replicator-status: {url-api-references-replicator-status}{sep}c:android(cs){api-pfx}ReplicatorStatus
...
:url-api-references-replicator-config-prop: {url-api-references-replicator-config}{sep}c:android(cs){api-pfx}ReplicatorConfiguration
