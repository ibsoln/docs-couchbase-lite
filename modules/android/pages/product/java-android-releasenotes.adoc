...
=== Documentation
* link:https://ibsoln.github.io/stage/h2beta/couchbase-lite/2.8/android/learn/java-android-p2psync-websocket.html[Beta Documentation for peer-to-peer]
* link:https://ibsoln.github.io/stage/api/mobile/2.8.0/couchbase-lite-android/Classes/URLEndpointListener.html[API References]
...
== OS Support
Couchbase Lite {param-platform} peer-to-peer functionality will be supported on
